...
@section('body') < !DOCTYPE html>
    ...
    <head>
        ...
        < !-- Bootstrap core CSS -->
            ...
            < !-- Custom styles for this template <link href="css/signin.css" rel="stylesheet">-->< !-- HTML5 shim and
            ...
            <div align="center">
                <div style="width: 400px; padding: 20px;">
                    <form name="formindex2" class="form-signin" role="form" method="post" action="acesso.php">
                        <div align="center"><img class="img-responsive" src="icone_300.png" width="300" height="300"
                        ...
                        < !-- /input-group --><br><input type="email" name="email" class="form-control"
